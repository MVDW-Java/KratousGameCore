...
public class b$b {
   ...
   private static final long I(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = -1232084492515321668L;
   ...
   private static final void V() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(c(I(U()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = -37;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = p(var1, b(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{-1173738207, -1770386810, -122684877, 1418854363};
   ...
   static final String n(Object var0) {
      ...
      int[] var1 = (int[])((int[])x[6]);
      int var2 = var1[0];
      int var3 = var1[1];
      int var4 = var1[2];
      int var26 = var1[3];
      int[] var5 = (int[])((int[])x[5]);
