...
public class a$p {
   ...
   private static final int R(int var0, int var1) {
      boolean var5 = false;
      int var2 = var0;
      int var3 = var1;
   ...
   private static final byte[] T(long var0) {
   ...
   private static final long O(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = -1093031581914079806L;
   ...
   private static final void v() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(T(O(C()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = -99;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = W(var1, R(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{729155766, 1807104598, -334190815, -151595203};
   ...
   static final String x(Object var0) {
      ...
      int[] var1 = (int[])((int[])G[6]);
      int var2 = var1[0];
      int var3 = var1[1];
      int var4 = var1[2];
      int var26 = var1[3];
      int[] var5 = (int[])((int[])G[5]);
