...
public class q$m$2 {
   ...
   private static final long t(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = 2673174743177417410L;
   ...
   private static final void z() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(Z(t(Z()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = -69;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = T(var1, V(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{-1495569734, -101682941, -1354104305, -535805910};
