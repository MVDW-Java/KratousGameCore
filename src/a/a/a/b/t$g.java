...
public class t$g {
   ...
   private static final int q(int var0, int var1) {
      boolean var5 = false;
      int var2 = var0;
      int var3 = var1;
   ...
   private static final int W(byte[] var0, int var1) {
      boolean var4 = false;
      int var2 = var0[10] << 16;
      var4 = false;
      Object var10000 = null;
   ...
   private static final byte[] A(long var0) {
   ...
   private static final long Q(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = 8055740109083071399L;
   ...
   private static final void c() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(A(Q(D()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = 113;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = W(var1, q(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{1195526386, -728189129, -932337909, 13891394};
      Object[] var28 = new Object[]{var1, var2, var3, var4, var5, var12, var29};
      o = var28;
   }

   static final String J(Object var0) {
      boolean var21 = false;
      boolean var22 = false;
      if (o == null) {
         c();
      ...
      int[] var1 = (int[])((int[])o[6]);
      int var2 = var1[0];
      int var3 = var1[1];
      int var4 = var1[2];
      int var26 = var1[3];
      int[] var5 = (int[])((int[])o[5]);
      int[] var6 = (int[])((int[])o[1]);
      int[] var7 = (int[])((int[])o[2]);
      int[] var8 = (int[])((int[])o[3]);
      int[] var9 = (int[])((int[])o[4]);
      byte[] var10 = (byte[])((byte[])o[0]);
