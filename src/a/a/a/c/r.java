...
public class r {
   ...
   private static final byte[] J(long var0) {
   ...
   private static final long M(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = 3996630342708958161L;
   ...
   private static final void E() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(J(M(A()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = 56;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = c(var1, V(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{1729186913, -589579625, -2118411382, -1951629716};
      Object[] var28 = new Object[]{var1, var2, var3, var4, var5, var12, var29};
      L = var28;
   }

   static final String h(Object var0) {
      boolean var21 = false;
      boolean var22 = false;
      if (L == null) {
         E();
      ...
      int[] var1 = (int[])((int[])L[6]);
      int var2 = var1[0];
      int var3 = var1[1];
      int var4 = var1[2];
      int var26 = var1[3];
      int[] var5 = (int[])((int[])L[5]);
      int[] var6 = (int[])((int[])L[1]);
      int[] var7 = (int[])((int[])L[2]);
      int[] var8 = (int[])((int[])L[3]);
      int[] var9 = (int[])((int[])L[4]);
      byte[] var10 = (byte[])((byte[])L[0]);
