...
public class b$a {
   ...
   private static final byte[] l(long var0) {
   ...
   private static final long h(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = 8145225527927590039L;
   ...
   private static final void z() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(l(h(A()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = 110;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = t(var1, n(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{751128899, 130255447, 1954145588, 344224391};
