...
public class a$a$3 {
   ...
   private static final int j(int var0, int var1) {
      boolean var5 = false;
      int var2 = var0;
      int var3 = var1;
   ...
   private static final int n(byte[] var0, int var1) {
      boolean var4 = false;
      int var2 = var0[10] << 16;
      var4 = false;
      Object var10000 = null;
   ...
   private static final byte[] e(long var0) {
   ...
   private static final long H(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = 6033254108748126621L;
   ...
   private static final void U() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(e(H(L()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = -15;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = n(var1, j(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{1917890554, 1782846852, -1436395010, -2110785609};
      Object[] var28 = new Object[]{var1, var2, var3, var4, var5, var12, var29};
      B = var28;
   }

   static final String x(Object var0) {
      boolean var21 = false;
      boolean var22 = false;
      if (B == null) {
         U();
      ...
      int[] var1 = (int[])((int[])B[6]);
      int var2 = var1[0];
      int var3 = var1[1];
      int var4 = var1[2];
      int var26 = var1[3];
      int[] var5 = (int[])((int[])B[5]);
      int[] var6 = (int[])((int[])B[1]);
      int[] var7 = (int[])((int[])B[2]);
      int[] var8 = (int[])((int[])B[3]);
      int[] var9 = (int[])((int[])B[4]);
      byte[] var10 = (byte[])((byte[])B[0]);
