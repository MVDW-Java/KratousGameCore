...
public class g$f {
   ...
   private static final long e(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = -9216672431204495516L;
   ...
   private static final void T() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(l(e(f()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = -55;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = F(var1, e(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{-23409362, -1462967083, -1997077339, 57033824};
