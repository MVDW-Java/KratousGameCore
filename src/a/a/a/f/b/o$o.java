...
public class o$o {
   ...
   private static final int z(byte[] var0, int var1) {
      boolean var4 = false;
      int var2 = var0[10] << 16;
      var4 = false;
      Object var10000 = null;
   ...
   private static final byte[] C(long var0) {
   ...
   private static final long K(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = 8711128209035610525L;
   ...
   private static final void r() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(C(K(m()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = 79;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = z(var1, L(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{460724226, -1704618028, 602302703, -854689698};
   ...
   static final String w(Object var0) {
      ...
      int[] var1 = (int[])((int[])H[6]);
      int var2 = var1[0];
      int var3 = var1[1];
      int var4 = var1[2];
      int var26 = var1[3];
      int[] var5 = (int[])((int[])H[5]);
      int[] var6 = (int[])((int[])H[1]);
      int[] var7 = (int[])((int[])H[2]);
      int[] var8 = (int[])((int[])H[3]);
      int[] var9 = (int[])((int[])H[4]);
      byte[] var10 = (byte[])((byte[])H[0]);
