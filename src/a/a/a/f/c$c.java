...
public class c$c {
   ...
   private static final int V(byte[] var0, int var1) {
      boolean var4 = false;
      int var2 = var0[10] << 16;
      var4 = false;
      Object var10000 = null;
   ...
   private static final long k(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = -6208902385725340347L;
   ...
   private static final void z() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(F(k(N()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = 67;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = V(var1, p(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{-1939417358, -966314074, 1738874507, 1269765611};
