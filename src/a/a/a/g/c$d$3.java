...
public class c$d$3 {
   ...
   private static final byte[] I(long var0) {
   ...
   private static final long i(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = -5400950809975355109L;
   ...
   private static final void V() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(I(i(p()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = -128;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = n(var1, E(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{1369177562, 291538325, -1417358359, -103898142};
      Object[] var28 = new Object[]{var1, var2, var3, var4, var5, var12, var29};
      P = var28;
   }

   static final String Z(Object var0) {
      boolean var21 = false;
      boolean var22 = false;
      if (P == null) {
         V();
      ...
      int[] var1 = (int[])((int[])P[6]);
      int var2 = var1[0];
      int var3 = var1[1];
      int var4 = var1[2];
      int var26 = var1[3];
      int[] var5 = (int[])((int[])P[5]);
      int[] var6 = (int[])((int[])P[1]);
      int[] var7 = (int[])((int[])P[2]);
      int[] var8 = (int[])((int[])P[3]);
      int[] var9 = (int[])((int[])P[4]);
      byte[] var10 = (byte[])((byte[])P[0]);
