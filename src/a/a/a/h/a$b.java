...
public class a$b {
   ...
   private static final long D(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = -6920857577006296336L;
   ...
   private static final void o() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(i(D(c()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = -13;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = D(var1, M(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{-2037025596, 592729495, -694274425, 279294025};
      Object[] var28 = new Object[]{var1, var2, var3, var4, var5, var12, var29};
      e = var28;
   }

   static final String Ja(Object var0) {
      boolean var21 = false;
      boolean var22 = false;
      if (e == null) {
         o();
      ...
      int[] var1 = (int[])((int[])e[6]);
      int var2 = var1[0];
      int var3 = var1[1];
      int var4 = var1[2];
      int var26 = var1[3];
      int[] var5 = (int[])((int[])e[5]);
