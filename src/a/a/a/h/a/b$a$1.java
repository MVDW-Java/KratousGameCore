...
public class b$a$1 {
   ...
   private static final void x() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(g(d(s()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = -124;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = u(var1, A(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{-1549491710, 1973443499, 1375277257, 1806756094};
