...
public class d$c$3 {
   ...
   private static final byte[] f(long var0) {
   ...
   private static final long M(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = 6690891364498041821L;
   ...
   private static final void N() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(f(M(e()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = 63;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = j(var1, M(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{-265749373, 1020210647, -1473157119, 1469245603};
      Object[] var28 = new Object[]{var1, var2, var3, var4, var5, var12, var29};
      s = var28;
   }

   static final String K(Object var0) {
      boolean var21 = false;
      boolean var22 = false;
      if (s == null) {
         N();
      ...
      int[] var1 = (int[])((int[])s[6]);
      int var2 = var1[0];
      int var3 = var1[1];
      int var4 = var1[2];
      int var26 = var1[3];
      int[] var5 = (int[])((int[])s[5]);
