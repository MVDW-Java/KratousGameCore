...
public class d$a$2 {
   ...
   private static final int x(int var0, int var1) {
      boolean var5 = false;
      int var2 = var0;
      int var3 = var1;
   ...
   private static final int d(byte[] var0, int var1) {
      boolean var4 = false;
      int var2 = var0[10] << 16;
      var4 = false;
      Object var10000 = null;
   ...
   private static final long R(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = -4050340367388468988L;
   ...
   private static final void f() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(z(R(k()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = -94;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = d(var1, x(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{1569927946, 1931713809, 1796957370, 866060504};
      Object[] var28 = new Object[]{var1, var2, var3, var4, var5, var12, var29};
      w = var28;
   }

   static final String d(Object var0) {
      boolean var21 = false;
      boolean var22 = false;
      if (w == null) {
         f();
      ...
      int[] var1 = (int[])((int[])w[6]);
      int var2 = var1[0];
      int var3 = var1[1];
      int var4 = var1[2];
      int var26 = var1[3];
      int[] var5 = (int[])((int[])w[5]);
