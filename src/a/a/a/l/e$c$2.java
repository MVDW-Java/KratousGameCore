...
public class e$c$2 {
   ...
   private static final byte[] d(long var0) {
   ...
   private static final long t(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = 5388314547616153108L;
   ...
   private static final void H() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(d(t(R()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = -89;
                        break label150;
                     }
      ...
      int[] var29 = new int[]{721207315, -1407638176, -937793409, -450194211};
