...
public class a$a$1 {
   ...
   private static final byte[] G(long var0) {
   ...
   private static final long S(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = 3134650942641352370L;
   ...
   private static final void E() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(G(S(F()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = 50;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = T(var1, W(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{-1586197840, -1569791299, -465503569, -834047888};
      Object[] var28 = new Object[]{var1, var2, var3, var4, var5, var12, var29};
      Z = var28;
   }

   static final String N(Object var0) {
      boolean var21 = false;
      boolean var22 = false;
      if (Z == null) {
         E();
      ...
      int[] var1 = (int[])((int[])Z[6]);
      int var2 = var1[0];
      int var3 = var1[1];
      int var4 = var1[2];
      int var26 = var1[3];
      int[] var5 = (int[])((int[])Z[5]);
      int[] var6 = (int[])((int[])Z[1]);
      int[] var7 = (int[])((int[])Z[2]);
      int[] var8 = (int[])((int[])Z[3]);
      int[] var9 = (int[])((int[])Z[4]);
      byte[] var10 = (byte[])((byte[])Z[0]);
