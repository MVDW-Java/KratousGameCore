...
public class b$d {
   ...
   private static final long C(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = -5108403951064703524L;
   ...
   private static final void o() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(q(C(I()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = -10;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = a(var1, Z(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{1129952299, 613696120, -1634960018, 847388781};
