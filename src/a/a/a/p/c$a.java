...
public class c$a {
   ...
   private static final int K(int var0, int var1) {
      boolean var5 = false;
      int var2 = var0;
      int var3 = var1;
   ...
   private static final byte[] Q(long var0) {
   ...
   private static final long B(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = -8794869697708174900L;
   ...
   private static final void Z() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(Q(B(H()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = 98;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = C(var1, K(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{-1342681693, 159133443, 1856946326, -879792515};
   ...
   static final String o(Object var0) {
      ...
      int[] var1 = (int[])((int[])q[6]);
      int var2 = var1[0];
      int var3 = var1[1];
      int var4 = var1[2];
      int var26 = var1[3];
      int[] var5 = (int[])((int[])q[5]);
