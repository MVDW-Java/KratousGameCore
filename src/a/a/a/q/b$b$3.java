...
public class b$b$3 {
   ...
   private static final byte[] M(long var0) {
   ...
   private static final long p(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = 7818964672745404911L;
   ...
   private static final void h() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(M(p(F()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = -1;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = y(var1, a(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{1380301490, 130892990, 255820317, 34367122};
      Object[] var28 = new Object[]{var1, var2, var3, var4, var5, var12, var29};
      d = var28;
   }

   static final String t(Object var0) {
      boolean var21 = false;
      boolean var22 = false;
      if (d == null) {
         h();
      ...
      int[] var1 = (int[])((int[])d[6]);
      int var2 = var1[0];
      int var3 = var1[1];
      int var4 = var1[2];
      int var26 = var1[3];
      int[] var5 = (int[])((int[])d[5]);
      int[] var6 = (int[])((int[])d[1]);
      int[] var7 = (int[])((int[])d[2]);
      int[] var8 = (int[])((int[])d[3]);
      int[] var9 = (int[])((int[])d[4]);
      byte[] var10 = (byte[])((byte[])d[0]);
