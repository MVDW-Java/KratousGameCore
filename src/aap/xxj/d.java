...
public class d {
   ...
   private static final byte[] S(long var0) {
   ...
   private static final long a(long var0) {
      boolean var9 = false;
      long var2 = var0;
      long var4 = 8222820474322564812L;
   ...
   private static final void U() {
            ...
            while(true) {
               try {
                  try {
                     if (!var15) {
                        var15 = true;
                        System.arraycopy(S(a(p()) ^ var7 - System.currentTimeMillis() >> 63 & 1L), 0, var26, 0, 8);
                        var26[16] = 9;
                        break label150;
                     }
         ...
         while(true) {
            ...
            try {
               ...
               while(true) {
                  ...
                  if (var14 % var25 == 0) {
                     var10 = p(var1, W(var10, 8)) ^ var6[var14 / var25 - 1];
      ...
      int[] var29 = new int[]{-1643590613, 1442815472, -649467091, 584120903};
